...
(function($) {
    ...
    navigation.before('<button class="navigation__toggle" type="button" aria-label ="Toggle Menu" aria-controls="Main Menu" aria-expanded="false" title="Toggle Menu"><span class = "sr-only">Open Menu</span>Devcamp</button>');
    ...
    function toggleNav() {
        navigation_toggle.click(function() {
            ...
            navigation_icon.toggleClass("navigation__icon-menu-close", "navigation__icon-menu");
        });
    }
})(jQuery);
/**
    ...
    function faq() {
        $(document).ready(function() {
            button.on("click", function() {
                $(this).next().slideToggle(speed).toggleAttrVal('aria-expanded', 'true', 'false');
            });
        });
    }
})(jQuery);
